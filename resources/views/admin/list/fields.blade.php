    ...
    <div class="col-md-12">
        <div class="box box-primary">
            <div class="box-header with-border">
                ...
                <h3 class="box-title"> 列表编辑</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
                <div class="row">
                    <div class="form-group">
                        {!! Form::label('title', '列表名称',['class'=>'col-sm-2 control-label']) !!}
                        <div class="col-sm-4">
                            {!! Form::text('title', old('title'), ['class' => 'form-control','placeholder' => '请填写列表名称']) !!}
                        </div>
                    </div>

                    <div class="form-group">
                        {!! Form::label('category', '列表栏目',['class'=>'col-sm-2 control-label']) !!}
                        <div class="col-sm-4 ">
                    ...
                    <div class="form-group">
                        {!! Form::label('description', '列表简介',['class'=>'col-sm-2 control-label']) !!}
                        <div class="col-sm-9">
                    ...
                    <div class="form-group">
                        {!! Form::label('content', '列表内容',['class'=>'col-sm-2 control-label']) !!}
                        <div class="col-sm-9">
