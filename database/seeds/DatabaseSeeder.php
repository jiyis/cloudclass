...
class DatabaseSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $array = [
            ...
            //"insert  into `".$prefix."role_has_permissions`(`permission_id`,`role_id`) values (3,2),(30,2)",
